...
- Flat source-calibrated PBR remains appropriate for genuinely smooth roles
  ...
  tile, or paving.
- Courthouse v8, lodge v13, and Siheyuan v8 are the first corrected trio to pass
  this builder material scan. They remain `NOT_A_KEEPER` with independent
  keeper approval pending.
