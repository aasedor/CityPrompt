...
building, street and park catalogue; it supersedes the previous priority on fine
foundation/rail joins and comprehensive accessibility work.

Construction detailing, tiny seams, comprehensive code/accessibility assessment,
exhaustive rare cases and mobile support can wait unless needed by an advertised
classroom feature. Maintain honest concept limitations. Do not claim accessibility
or asset/publication approval from a working classroom scene.

## Five practical gates

**User scheduling update — 22 September:** students are unavailable until winter.
The requested [simulated student exercise](SIMULATED_STUDENT_EXERCISE_2026-09-22.md)
passes the fresh-project prepared-site create/edit/Undo/Redo/reload/download path,
with recoverable placement and rotation retries recorded. Treat it as a provisional
prototype checkpoint and proceed with bounded catalogue work; do not wait for
winter to continue development. Independent novice usability remains unverified,
and existing asset approval/publication gates still apply.

**Current checkpoint — 22 September:** the
[ground/export repair](CLASSROOM_GROUND_EXPORT_2026-09-22.md) closes the large
prepared-site edge and verifies public-road editing, Undo/Redo, reload and actual
PNG download. The [first-session pack](CLASSROOM_FIRST_SESSION_2026-09-22.md)
updates the in-app guide and supplies student/instructor handouts. Next is a short
trial with actual novices, then fixes driven by their observations and a bounded
catalogue batch. Earlier “next work” entries below retain historical detail;
independent student usability is still unverified. Do not mistake agent-authored
Currie exercises for an independent student pass.
...
| Useful visuals | Clean, useful camera views; reliable exact export; AI output preserves the student's actual design | Fresh free export passed. One bounded real Photo Realistic image was visually strong but failed source-layout checks; the UI returned the authoritative 3D view and retained the generated image for explicit unverified review. See `CURRIE_IMAGE_FIDELITY_PILOT_2026-09-20.md`. The street's vehicle semantics are ambiguous at the tested aerial camera. |
...
3. **Control clarity (checkpoint passed):** boundary exclusion errors now name
   unnamed objects, and the native-house instructions point to its working Move handle. The legacy
   Generate to 3D route now builds the seven-house Currie scene through its
   strict locked recipe; see `CURRIE_GENERATE_3D_RECIPE_REPAIR_2026-09-20.md`.
   See `CURRIE_BOUNDARY_EXCLUSION_LABELS_2026-09-20.md` for the rejected-edit
   readback.
   Prioritize actual
...
marked complete by this narrower classroom target.
