...
EXPANSION_SYSTEM = (
    ...
    "intensity 0-1 reflects how strongly the brief leans that way. Examples: "
    "'make it beautiful / European grandeur / grand boulevards' -> city_beautiful; "
    "'keep the neighbours happy / sensible returns / fits the area' -> "
    "developer_feasibility with neighbourhood_context secondary; 'car-free / "
    "cycling city / net zero' -> climate_resilience with transit_oriented secondary.\n"
