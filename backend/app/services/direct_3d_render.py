        ...
        *,
        ...
        try:
            ...
            if req.view_mode == "street":
                # Street v1 is review-first: the aerial gates (registration,
                # macro planform fidelity, visual-change) encode top-down
                # assumptions, so run only generic content sanity and hand the
                # candidate to human review with the source for comparison.
