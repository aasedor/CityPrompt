"""Create phone-readable reference/model comparison sheets for Wave 12."""
...
FAMILIES = {
    "vertical-forest-residential": {
        "title": "Vertical Forest Residential - reference-locked LEGO family",
        "detail_source": "occupied-residential-source-v1.png",
        "detail_render": "facade_close",
        "detail_label": "MODEL - REAL PLANTERS / TREES / BALCONY DEPTH / GLASS",
    },
    "collegiate-gothic-gatehouse": {
        "title": "Collegiate Gothic Gatehouse - reference-locked LEGO family",
        "detail_source": "carved-stone-material-source-v1.png",
        "detail_render": "identity_close",
        "detail_label": "MODEL - PIERCED GATE / TRACERY / LEAD CAMES / ASHLAR",
    },
    "cable-stayed-airport-terminal": {
        "title": "Cable-Stayed Airport Terminal - reference-locked LEGO family",
        "detail_source": "occupied-terminal-source-v1.png",
        "detail_render": "facade_close",
        "detail_label": "MODEL - TREE COLUMNS / OCCUPIED GLASS / CANOPY LOAD PATH",
    },
}
...
def create_sheet(family: str) -> Path:
    ...
    root_copy = ROOT / f"wave12-{family}-comparison.jpg"
    sheet.save(root_copy, quality=91, optimize=True, progressive=True)
    print(f"[wave12-comparison] {destination.relative_to(REPO)}")
    return destination
