...
def test_wave3_theater_variant_injects_aliases_and_fixed_identity_kits():
    from signature_profiles import inject_signature

    grammar = {
        "source": {
            "archetype_id": "deco_theater_mainstreet",
            "variant_id": "deco_theater_movie_palace",
        },
        "dimensions": {},
        "materials": {
            "primary": {}, "secondary": {}, "accent": {}, "glass": {}, "roof": {},
        },
    }
    result = inject_signature(grammar)

    assert result["archetype_aliases"] == [
