...
GLASS_PROFILES: dict[str, dict[str, float | str]] = {
    ...
    "heritage_dormer_dark": {
        "label": "Dark recessed heritage dormer glazing",
        "tint": "#20292a",
        "roughness": 0.16,
        "transmission": 0.24,
        "ior": 1.49,
        ...
        "specular_ior_level": 0.40,
        "interior_depth_m": 0.62,
        "frame_depth_m": 0.12,
        "pane_recess_m": 0.16,
        "environment_intensity": 0.82,
        "interior_light_color": "#d9a460",
        "interior_light_strength": 0.30,
        "glass_emission_strength": 0.004,
        "baked_glass_emission": 0.012,
        "baked_glass_mix": 0.32,
        "surface_alpha": 1.0,
    },
    "heritage_stained_glass_luminous": {
        "label": "Luminous heritage stained-glass dome",
        "tint": "#d3ba84",
        "roughness": 0.16,
        "transmission": 0.42,
        "ior": 1.49,
        ...
        "interior_depth_m": 1.10,
        "frame_depth_m": 0.16,
        "pane_recess_m": 0.10,
        "environment_intensity": 0.82,
        "interior_light_color": "#ffd08a",
        "interior_light_strength": 0.82,
        "glass_emission_strength": 0.045,
        "baked_glass_emission": 0.12,
        "baked_glass_mix": 0.52,
        "surface_alpha": 1.0,
    },
}
