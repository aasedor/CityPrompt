"""Publish the approved Administrative Faculty Office V98 evidence package."""
...
REFERENCE = ROOT / "frontend/public/archetypes/buildings/administrative-faculty-office-building"
CANONICAL = ROOT / "artifacts/administrative-faculty-office-v98/beauty-canonical-v7"
EXTENDED = ROOT / "artifacts/administrative-faculty-office-v98/beauty-extended-v8"
OUTPUT = ROOT / "docs/reviews/catalogue-rollout-v98/sticker-method-batch-01/administrative-faculty-office"
...
def _publish_tier(tier: str, folder: Path) -> dict:
    family = f"administrative-faculty-office-v98-{tier}"
...
def main() -> None:
    ...
    _board("01-exact-reference-comparison.png", "Administrative Faculty Office V98 — exact identity", [
        (REFERENCE / "variant_0.png", "EXACT ARCHETYPE"),
        (CANONICAL / "administrative-faculty-office-v98-canonical_archetype_match.png", "CANONICAL · 30 × 20 m"),
        (EXTENDED / "administrative-faculty-office-v98-extended_archetype_match.png", "EXTENDED · 37.5 × 20 m"),
    ])
    _board("02-oblique-reference-comparison.png", "Brick field, recessed portal and singular bronze bay", [
        (REFERENCE / "variant_0_angle_60.jpg", "EXACT 60° REFERENCE"),
        (CANONICAL / "administrative-faculty-office-v98-canonical_front_corner_oblique.png", "CANONICAL"),
        (EXTENDED / "administrative-faculty-office-v98-extended_front_corner_oblique.png", "EXTENDED"),
    ])
    _board("03-roof-reference-comparison.png", "Flat gravel roof and screened mechanical court", [
        (REFERENCE / "variant_0_angle_90.jpg", "EXACT AERIAL REFERENCE"),
        (CANONICAL / "administrative-faculty-office-v98-canonical_aerial.png", "CANONICAL AERIAL"),
        (EXTENDED / "administrative-faculty-office-v98-extended_aerial.png", "EXTENDED AERIAL"),
    ], contain=True)
    _board("04-size-matrix-close.png", "Physical glass, brick/bronze ownership and constant material scale", [
        (CANONICAL / "administrative-faculty-office-v98-canonical_facade_close.png", "CANONICAL CLOSE"),
        (EXTENDED / "administrative-faculty-office-v98-extended_facade_close.png", "EXTENDED CLOSE"),
    ])
