"""Validate and apply the executable quality memory to all Wave 12 families."""
...
def main() -> int:
    ...
    for family in FAMILIES:
        ...
        report = validate_family(root, grammar)
        ...
        print(
            f"[wave12-assessor] {family}: validation={report['status']} "
