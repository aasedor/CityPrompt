...
SPEC_PATH = REPOSITORY_ROOT / "tools/park_asset_compiler/park_depth_batch2_reference_spec.json"
ASSET_ROOT = REPOSITORY_ROOT / "assets/park-depth-kits/staging-batch2"
...
def test_batch_references_have_three_catalogue_angles() -> None:
    ...
    assert spec["modeling_contract"]["runtime_glb_includes_draped_ground_surface"] is False
...
def test_staged_glbs_match_manifest_hashes_and_contract() -> None:
    ...
    assert manifest["batch_id"] == "park_depth_kits_batch2"
    ...
    for record in manifest["assets"]:
        ...
        assert record["runtime_glb_includes_draped_ground_surface"] is False
