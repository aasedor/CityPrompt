"""Render the ten-family, four-variant Batch 21 reference/skin sheet."""
...
SCHEDULE = Path(__file__).with_name("park_archetype_batch21_skin_sources.json")
DEFAULT_OUT = REPO_ROOT / "docs/park_lego_batch21/park_lego_batch21_four_variant_sheet.jpg"
PARENTS = (
    "athletics_precinct_sports_fields", "community_garden",
    "fountain_water_feature", "pond_lake", "market_square",
    "formal_civic_plaza", "linear_park_greenway", "promenade_boardwalk",
    "swimming_pool_complex", "rooftop_garden",
)
ANCHORS = {
    ("athletics_precinct_sports_fields", 0): "athletics-fields-regulation",
    ("community_garden", 0): "community-garden-allotments",
    ("fountain_water_feature", 1): "fountain-formal-reflecting-pool",
    ("pond_lake", 0): "pond-lake-naturalistic",
    ("market_square", 1): "market-square-festival-lawn",
    ("formal_civic_plaza", 0): "formal-civic-plaza-v0",
    ("linear_park_greenway", 0): "linear-greenway-rail-trail-v0",
    ("promenade_boardwalk", 0): "promenade-maritime-boardwalk",
    ("swimming_pool_complex", 0): "swimming-natural-pond",
    ("rooftop_garden", 0): "rooftop-intensive-garden-v0",
}
...
def main() -> None:
    ...
    draw.text((32, 22), "PARK LEGO BATCH 21 - PROGRAM / LANDSCAPE REFERENCE-SKIN CLOSURE", fill="white", font=font)
    draw.text((32, 48), "30 new exact-reference skins + 10 retained anchors | regulation and parcel-adaptive LEGO grammar | no people, AI drape, or embedded buildings", fill="#c9d8c8", font=font)
