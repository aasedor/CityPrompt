"""Render the ten-family, four-variant Batch 22 reference/skin sheet."""
...
SCHEDULE = Path(__file__).with_name("park_archetype_batch22_skin_sources.json")
DEFAULT_OUT = REPO_ROOT / "docs/park_lego_batch22/park_lego_batch22_four_variant_sheet.jpg"
PARENTS = (
    "cemetery_memorial_grounds", "courtyard_plaza", "transit_plaza",
    "amphitheater_performance_space", "stormwater_retention_pond",
    "canal_waterway", "custom_parks_plazas", "nature_preserve",
    "riverfront_park_beach", "street_plaza_parklet",
)
ANCHORS = {
    ("cemetery_memorial_grounds", 0): "cemetery-classical-formal-v0",
    ("courtyard_plaza", 1): "courtyard-contemporary-water-v1",
    ("transit_plaza", 2): "transit-green-civic-v2",
    ("amphitheater_performance_space", 0): "amphitheater-terraced-v0",
    ("stormwater_retention_pond", 0): "pond-lake-naturalistic",
    ("canal_waterway", 3): "canal-ecological-wetland-v3",
    ("custom_parks_plazas", 1): "custom-biophilic-urban-v1",
    ("nature_preserve", 1): "nature-preserve-tallgrass-prairie",
    ("riverfront_park_beach", 1): "riverfront-lake-swimming-beach",
    ("street_plaza_parklet", 1): "street-parklet-sf-timber-v1",
}
...
def main() -> None:
    ...
    draw.text((32, 22), "PARK LEGO BATCH 22 - MEMORIAL / CIVIC / WATER / ECOLOGY CLOSURE", fill="white", font=font)
