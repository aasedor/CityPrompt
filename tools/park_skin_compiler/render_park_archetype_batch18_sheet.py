"""Render the ten-family, four-variant Batch 18 specialty-family sheet."""
...
SCHEDULE = Path(__file__).with_name("park_archetype_batch18_skin_sources.json")
DEFAULT_OUT = REPO_ROOT / "docs/park_lego_batch18/park_lego_batch18_four_variant_sheet.jpg"
PARENTS = (
...
ANCHORS = {
    ("disc_golf_course", 0): "disc-golf-wooded-championship",
    ("bocce_petanque_court", 0): "bocce-italian-piazza",
    ("climbing_bouldering_wall", 0): "climbing-competition-boulder",
    ("mini_golf_course", 0): "mini-golf-classic-themed",
    ("beach_volleyball_courts", 0): "beach-volleyball-competition",
    ("pollinator_meadow", 0): "pollinator-prairie-restoration",
    ("urban_orchard_food_forest", 0): "urban-orchard-heritage-apple",
    ("bioswale_rain_garden", 0): "bioswale-streetside",
    ("sculpture_garden", 0): "sculpture-museum-court",
    ("labyrinth_meditation", 0): "labyrinth-classical-stone",
}
...
def main() -> None:
    ...
    draw.text((32, 22), "PARK LEGO BATCH 18 - SPECIALTY FAMILY REFERENCE / SKIN CLOSURE", fill="white", font=font)
