"""Render the ten-family, four-variant Batch 17 activity-family sheet."""
...
SCHEDULE = Path(__file__).with_name("park_archetype_batch17_skin_sources.json")
DEFAULT_OUT = REPO_ROOT / "docs/park_lego_batch17/park_lego_batch17_four_variant_sheet.jpg"
PARENTS = (
    "pickleball_courts", "soccer_pitch_caged", "running_track_oval",
    "outdoor_fitness_circuit", "baseball_softball_diamond", "cricket_pitch_oval",
    "nature_play_area", "inclusive_playground", "pump_track", "splash_pad_area",
)
ANCHORS = {
    ("pickleball_courts", 1): "pickleball-community-bank",
    ("soccer_pitch_caged", 0): "caged-soccer-european",
    ("running_track_oval", 2): "track-oval-school-athletic",
    ("outdoor_fitness_circuit", 0): "outdoor-fitness-calisthenics",
    ("baseball_softball_diamond", 1): "baseball-youth-pinwheel",
    ("cricket_pitch_oval", 0): "cricket-village-green",
    ("nature_play_area", 0): "nature-play-forest-adventure",
    ("inclusive_playground", 0): "inclusive-accessible-playground",
    ("pump_track", 0): "pump-track-asphalt-competition",
    ("splash_pad_area", 0): "splash-pad-water-play",
}
...
def main() -> None:
    ...
    draw.text((32, 22), "PARK LEGO BATCH 17 - ACTIVITY FAMILY REFERENCE / SKIN CLOSURE", fill="white", font=font)
    draw.text((32, 48), "30 new archetype-derived skins + 10 retained anchors | regulation/whole modules | no people, AI drape, or embedded buildings", fill="#c9d8c8", font=font)
