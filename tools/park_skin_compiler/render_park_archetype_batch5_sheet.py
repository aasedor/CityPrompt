"""Render one mobile-friendly batch-5 reference/skin comparison sheet."""
...
SCHEDULE = Path(__file__).with_name("park_archetype_batch5_skin_sources.json")
DEFAULT_OUT = REPO_ROOT / "docs/park_lego_batch5/park_lego_batch5_reference_skin_sheet.jpg"
...
def main() -> None:
    ...
    draw.text((34, 24), "PARK LEGO BATCH 5 - EXACT ARCHETYPE REFERENCE + STATIONARY PBR SKINS", fill="white", font=font)
