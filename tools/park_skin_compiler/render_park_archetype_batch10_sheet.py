"""Render the mobile-friendly Batch 10 reference/skin comparison sheet."""
...
SCHEDULE = Path(__file__).with_name("park_archetype_batch10_skin_sources.json")
DEFAULT_OUT = REPO_ROOT / "docs/park_lego_batch10/park_lego_batch10_reference_skin_sheet.jpg"
...
def main() -> None:
    ...
    draw.text((34, 24), "PARK LEGO BATCH 10 - CITY-SPECIFIC REFERENCE + ADAPTIVE 3D FAMILY", fill="white", font=font)
    draw.text((34, 50), "10 previously uncovered parents - park evidence only - no people/buildings - zero API calls", fill="#c8d7c6", font=font)
