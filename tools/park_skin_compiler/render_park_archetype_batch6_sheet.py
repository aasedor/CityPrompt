"""Render one mobile-friendly batch-6 reference/skin comparison sheet."""
...
SCHEDULE = Path(__file__).with_name("park_archetype_batch6_skin_sources.json")
DEFAULT_OUT = REPO_ROOT / "docs/park_lego_batch6/park_lego_batch6_reference_skin_sheet.jpg"
...
def main() -> None:
    ...
    draw.text((34, 24), "PARK LEGO BATCH 6 - EXACT ARCHETYPE REFERENCE + STATIONARY PBR SKINS", fill="white", font=font)
    draw.text((34, 50), "10 exact variants - no people - no large buildings - zero API calls - source pixels never projected", fill="#c8d7c6", font=font)
