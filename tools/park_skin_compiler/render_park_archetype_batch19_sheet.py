"""Render the ten-family, four-variant Batch 19 destination-family sheet."""
...
SCHEDULE = Path(__file__).with_name("park_archetype_batch19_skin_sources.json")
DEFAULT_OUT = REPO_ROOT / "docs/park_lego_batch19/park_lego_batch19_four_variant_sheet.jpg"
PARENTS = (
    "outdoor_ice_rink", "kayak_launch_dock", "tidal_marsh_boardwalk",
    "outdoor_cinema_lawn", "food_truck_plaza", "festival_event_lawn",
    "campus_central_quad", "urban_beach", "velodrome_cycling_track",
    "mountain_bike_park",
)
ANCHORS = {
    ("outdoor_ice_rink", 3): "outdoor-ice-rink-multipurpose",
    ("kayak_launch_dock", 0): "kayak-river-launch",
    ("tidal_marsh_boardwalk", 0): "tidal-marsh-cordgrass",
    ("outdoor_cinema_lawn", 1): "outdoor-cinema-park-lawn",
    ("food_truck_plaza", 1): "food-truck-permanent-park",
    ("festival_event_lawn", 2): "festival-great-lawn",
    ("campus_central_quad", 0): "campus-naturalized-meadow-quad",
    ("urban_beach", 2): "urban-beach-family-splash",
    ("velodrome_cycling_track", 0): "velodrome-open-air",
    ("mountain_bike_park", 2): "mountain-bike-skills-dirt",
}
...
def main() -> None:
    ...
    draw.text((32, 22), "PARK LEGO BATCH 19 - DESTINATION FAMILY REFERENCE / SKIN CLOSURE", fill="white", font=font)
    draw.text((32, 48), "30 new archetype-derived skins + 10 retained anchors | parcel-adaptive LEGO grammar | no people, AI drape, or embedded buildings", fill="#c9d8c8", font=font)
