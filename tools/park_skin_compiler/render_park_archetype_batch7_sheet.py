"""Render one mobile-friendly batch-7 reference/skin comparison sheet."""
...
SCHEDULE = Path(__file__).with_name("park_archetype_batch7_skin_sources.json")
DEFAULT_OUT = REPO_ROOT / "docs/park_lego_batch7/park_lego_batch7_reference_skin_sheet.jpg"
...
def main() -> None:
    ...
    draw.text((34, 24), "PARK LEGO BATCH 7 - EXACT REFERENCE + ADAPTIVE 3D FAMILY", fill="white", font=font)
    draw.text((34, 50), "10 exact variants - human scale only - no people - no large buildings - zero API calls", fill="#c8d7c6", font=font)
