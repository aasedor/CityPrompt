"""Render the mobile-friendly Batch 9 reference/skin comparison sheet."""
...
SCHEDULE = Path(__file__).with_name("park_archetype_batch9_skin_sources.json")
DEFAULT_OUT = REPO_ROOT / "docs/park_lego_batch9/park_lego_batch9_reference_skin_sheet.jpg"
...
def main() -> None:
    ...
    draw.text((34, 24), "PARK LEGO BATCH 9 - REVIEWED REFERENCE + ADAPTIVE 3D FAMILY", fill="white", font=font)
