  ...
  return (
    <div className="card">
      <div className="mb-4 flex items-center justify-between">
        <h3 className="text-sm font-semibold text-primary-950/60 dark:text-white/60">Active Users</h3>
        <span className="text-xs text-primary-950/50 dark:text-white/50">{data.total_in_range} active</span>
      </div>
      <div className="h-64">
