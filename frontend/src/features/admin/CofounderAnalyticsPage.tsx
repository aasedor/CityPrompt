...
function SectionSpinner() {
  return (
    <div className="flex items-center justify-center py-12">
      <Loader2 className="h-6 w-6 animate-spin text-primary-950/50 dark:text-white/50" />
    </div>
  );
}
    ...
    <div>
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          <Link
            to="/admin"
            className="flex h-8 w-8 items-center justify-center rounded-lg text-primary-950/50 dark:text-white/50 hover:bg-primary-950/[0.04] dark:hover:bg-white/[0.04] hover:text-primary-950/70"
          >
            <ArrowLeft size={18} />
          </Link>
          <h1 className="text-2xl font-bold text-primary-950 dark:text-accent-50">Analytics</h1>
        </div>
      ...
      <div className="space-y-6">
        ...
        {settingsLoading && !platformSettings ? (
          ...
          <div className="rounded-xl border border-primary-950/[0.08] dark:border-white/[0.08] bg-white dark:bg-primary-900 p-6 shadow-card">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <div className="flex items-center gap-3">
                <select
                  ...
                  className="rounded-lg border border-primary-950/[0.1] dark:border-white/[0.1] bg-white dark:bg-primary-900 px-3 py-2 text-sm text-primary-950 dark:text-accent-50 shadow-card focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 disabled:opacity-50"
                >
                ...
                {settingsSaving && <Loader2 className="h-4 w-4 animate-spin text-primary-950/50 dark:text-white/50" />}
              </div>
            </div>
            <div className="mt-3 flex gap-4 text-xs text-primary-950/50 dark:text-white/50">
              <span className={platformSettings.claude_configured ? 'text-green-400' : 'text-primary-950/40 dark:text-white/40'}>
                Claude: {platformSettings.claude_configured ? 'configured' : 'not configured'}
              </span>
              <span className={platformSettings.gemini_configured ? 'text-green-400' : 'text-primary-950/40 dark:text-white/40'}>
