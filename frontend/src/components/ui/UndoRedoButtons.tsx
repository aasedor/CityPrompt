  ...
  return (
    <div className="flex items-center gap-1">
      <button
        ...
        className="rounded-lg p-1.5 text-primary-950/50 dark:text-white/50 hover:bg-primary-950/[0.06] dark:hover:bg-white/[0.06] hover:text-primary-950 dark:hover:text-accent-50 disabled:cursor-default disabled:text-primary-950/20 disabled:hover:bg-transparent"
        title="Undo (Ctrl+Z)"
      >
        <Undo2 size={16} />
      </button>
