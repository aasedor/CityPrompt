export function buildingGroundProblemMessage(reason?: string): string {
  ...
  if (reason === 'entrance_terrain_intersection') return 'The proposed entrance steps intersect the measured terrain. Move the building or choose a clearer approach; the ground has not been cut or flattened.';
