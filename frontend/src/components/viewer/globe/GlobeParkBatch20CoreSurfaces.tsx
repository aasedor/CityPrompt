...
export function GlobeParkBatch20CoreSurfaces(props: CoreSurfaceProps) {
  const skin = batch27ParkSkinForSelection(props.archetypeId, props.variantId)
    ?? batch26ParkSkinForSelection(props.archetypeId, props.variantId)
    ?? batch25ParkSkinForSelection(props.archetypeId, props.variantId)
